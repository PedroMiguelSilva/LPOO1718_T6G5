...
public class MyPanel extends JPanel implements KeyListener{
	...
	public void paintComponent(Graphics g){
		...
		BufferedImage ArmedH = scale(images.getHero(), elementWidth, elementHeight);//esta mal
		...
		BufferedImage StunedOgre = scale(images.getOgre(), elementWidth, elementHeight); //atenção!!
